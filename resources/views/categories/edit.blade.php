    ...
    <div class="bg-white p-6 rounded shadow max-w-2xl">
        <form action="{{ route('admin.categories.update', $category) }}" method="POST">
            ...
            <div class="flex gap-2">
                <button type="submit" class="bg-matcha-800 text-white px-6 py-2 rounded hover:bg-matcha-900 transition">Update Category</button>
                <a href="{{ route('categories.show', $category) }}" class="bg-gray-300 text-gray-700 px-6 py-2 rounded hover:bg-gray-400 transition">Cancel</a>
            </div>
        </form>
    </div>
@endsection
